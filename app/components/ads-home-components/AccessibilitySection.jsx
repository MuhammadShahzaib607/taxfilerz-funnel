        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 space-y-8">
            ...
            >
              ...
              {/* CTA Button */}
              <div className="pt-6">
                <a href="/home" className="px-8 py-4 bg-[#1D2F52] text-white rounded-2xl font-bold hover:shadow-2xl hover:shadow-[#1D2F52]/30 transition-all flex items-center gap-3 group">
                  Start Now
